...
{
    public class LegacyRectangleObject : LegacyDrawObject
    {
        public Rectangle Roi = new Rectangle();

        #region 생성자

        public LegacyRectangleObject() : this(0, 0, 0, 0)
        {

        }

        public LegacyRectangleObject(int x, int y, int width, int height)
            : base()
        {
        ...
        /// 이 객체를 복사한다.
        /// </summary>
        public override LegacyDrawObject Clone() => (LegacyRectangleObject)this.MemberwiseClone();
