...
{
    public abstract class LegacyDrawObject
    {
        #region 전역변수
        ...
        /// DrawObject 복사 함수
        /// </summary>
        public abstract LegacyDrawObject Clone();
        ...
        /// </summary>
        protected LegacyDrawObject DeepCopy() => (LegacyDrawObject)this.MemberwiseClone();
