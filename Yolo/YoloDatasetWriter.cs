...
namespace MvcVisionSystem.Yolo
{
    ...
    [XmlType(TypeName = "CYolov5TrainingParam")]
    [XmlInclude(typeof(LegacyYoloV5TrainingParameters))]
    public class YoloV5TrainingParameters
    {
    ...
    [XmlType(TypeName = "CYolov5TranningParam")]
    public class LegacyYoloV5TrainingParameters : YoloV5TrainingParameters
    {
    }

    public static class YoloDatasetWriter
    {
