...
- `EVIDENCE` [P0-C Clean-Source Transfer Bundle 0.1.2](P0C_CLEAN_SOURCE_TRANSFER_BUNDLE_0_1_2_20260801.md)
...
- `CONTRACT` [Recipe Apply Stability](RECIPE_APPLY_STABILITY_20260806.md)
...
- `EVIDENCE` [Segmentation Recipe UX, Accessibility, And Model-State Evidence](SEGMENTATION_RECIPE_UX_ACCESSIBILITY_20260819.md)
