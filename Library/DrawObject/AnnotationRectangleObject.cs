...
{
    public class AnnotationRectangleObject : RectangleDrawObject
    {
        private const int DefaultHandleSize = 12;

        public Yolo.LabelClass cClassItem = new Yolo.LabelClass();

        public override DrawObjectBase Clone() => (AnnotationRectangleObject)MemberwiseClone();
