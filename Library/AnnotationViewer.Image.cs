...
{
    public partial class AnnotationViewer
    {
        public void SetDisplayImage(Bitmap image, string imageName = "", string imagePath = "", bool resetAnnotations = false, bool zoomToFit = true)
        {
            ...
            {
                LabelingApplicationState.Inst.ImageWorkspace.SetActiveImage(imageName ?? string.Empty, imagePath ?? string.Empty, _currentImage);
            }
        }
        ...
        public void LoadMainImage(Bitmap image, string imageName, string imagePath = "")
        {
            ...
            LabelingApplicationState.Inst.ImageWorkspace.SetActiveImage(imageName ?? string.Empty, imagePath ?? string.Empty, _currentImage);
            DisplayManager.ImageSrc = BitmapConverter.ToMat(_currentImage);
        }
