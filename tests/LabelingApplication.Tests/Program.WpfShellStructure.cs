...
internal static class WpfShellStructureTests
{
    internal static void TestWpfLabelingShellWindowConstructs()
    {
        ...
        try
        {
            ...
            AssertTrue(ReferenceEquals(GetRuntimeButtonCommand(window.FindName("RightWorkflowDockToggleButton")), window.ShellViewModel.ToggleRightWorkflowDockCommand), "WPF expanded work-panel toggle should bind to the injected shell command at runtime");
            AssertTrue(ReferenceEquals(GetRuntimeButtonCommand(window.FindName("RightWorkflowRailOpenButton")), window.ShellViewModel.ToggleRightWorkflowDockCommand), "WPF collapsed work-panel opener should bind to the injected shell command at runtime");
            AssertTrue(ReferenceEquals(GetRuntimeButtonCommand(window.FindName("RightWorkflowSavedLabelsButton")), window.ShellViewModel.ShowSavedLabelsViewCommand), "WPF saved-label shortcut should bind to the injected shell command at runtime");
            AssertTrue(ReferenceEquals(GetRuntimeButtonCommand(window.FindName("RightWorkflowGuideToolsButton")), window.ShellViewModel.ShowLabelingGuideViewCommand), "WPF guide/tools shortcut should bind to the injected shell command at runtime");
            AssertTrue(ReferenceEquals(GetRuntimeButtonCommand(window.FindName("RightWorkflowClassCatalogButton")), window.ShellViewModel.ShowClassCatalogViewCommand), "WPF class-catalog shortcut should bind to the injected shell command at runtime");
            AssertTrue(ReferenceEquals(GetRuntimeButtonCommand(window.FindName("RightWorkflowRailSavedLabelsButton")), window.ShellViewModel.ShowSavedLabelsViewCommand), "WPF collapsed saved-label shortcut should bind to the injected shell command at runtime");
            AssertTrue(ReferenceEquals(GetRuntimeButtonCommand(window.FindName("RightWorkflowRailGuideToolsButton")), window.ShellViewModel.ShowLabelingGuideViewCommand), "WPF collapsed guide/tools shortcut should bind to the injected shell command at runtime");
            AssertTrue(ReferenceEquals(GetRuntimeButtonCommand(window.FindName("RightWorkflowRailClassCatalogButton")), window.ShellViewModel.ShowClassCatalogViewCommand), "WPF collapsed class-catalog shortcut should bind to the injected shell command at runtime");
